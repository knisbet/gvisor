...
type Bucketer interface {
	...
	// In other words, the lowest value for which BucketIndex(x) returns i
...
func (b *ExponentialBucketer) BucketIndex(sample int64) int {
	...
	// this code (less than 100), this is often faster than computing
	// a logarithm. It also consumes almost no stack space.
	lowIndex := 0
